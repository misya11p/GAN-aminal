print("コードは以下のものを使用")
print()
print("コピペOKです】Pythonを使って自動でGoogle画像を収集する方法を徹底解説！ | さすをブログ")
print("https://sasuwo.org/get-images-automatically-for-python/")
print('~'*20)
...
SAVE_DIR = os.path.join(BASE_DIR, '_'.join(QUERY.split()))
TIMEOUT = config['timeout']
ACCESS_WAIT = config['access_wait']
